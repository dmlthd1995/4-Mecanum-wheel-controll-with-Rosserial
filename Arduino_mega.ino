...
// 출력값 [ rad/s ]
Tar_wheel_front_left = (1/WHEEL_RADIUS) * (Tar_linear_x - Tar_linear_y - (WHEEL_SEPARATION_WIDTH +
WHEEL_SEPARATION_LENGTH)*Tar_angular_z); //Tar_wheel_front_left값 계산 수식
Tar_wheel_front_right = (1/WHEEL_RADIUS) * (Tar_linear_x + Tar_linear_y + (WHEEL_SEPARATION_WIDTH +
WHEEL_SEPARATION_LENGTH)*Tar_angular_z); //Tar_wheel_front_right값 계산 수식
Tar_wheel_rear_left = (1/WHEEL_RADIUS) * (Tar_linear_x + Tar_linear_y - (WHEEL_SEPARATION_WIDTH +
WHEEL_SEPARATION_LENGTH)*Tar_angular_z); //Tar_wheel_rear_left값 계산 수식
Tar_wheel_rear_right = (1/WHEEL_RADIUS) * (Tar_linear_x - Tar_linear_y + (WHEEL_SEPARATION_WIDTH +
WHEEL_SEPARATION_LENGTH)*Tar_angular_z); //Tar_wheel_rear_right값 계산 수식
